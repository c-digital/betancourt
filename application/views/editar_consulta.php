            ...
            <div class="panel-body panel-form">
                <div id="wrapper" class="customer_profile">
				   <div class="row" style="background: white;">
			         <?php echo form_open('/consultas/modificar', ['enctype' => 'multipart/form-data', 'method' => 'POST']); ?>
			            <div class="col-md-11">
			            ...
			            <div class="col-md-2">
			               <img style="width: 150px" class="img-responsive img-circle user_photo" style="cursor: pointer" src="<?php echo ($foto_perfil) ? '/uploads/consultas/' . $foto_perfil : '/assets/images/user-placeholder.jpg' ?>" alt="">
			            ...
			            <div class="col-md-8">
			               ...
			               <select name="patient_id" class="form-control">
			                  ...
			                  <?php foreach ($clientes as $cliente): ?>
			                     <option <?php echo ($cliente->patient_id == $consulta->patient_id) ? 'selected' : ''; ?> value="<?php echo $cliente->patient_id; ?>"><?php echo $cliente->nombre; ?></option>
			                  <?php endforeach; ?>
			               </select>
			            </div>
			                           ...
			                           <div class="form-group">
			                              ...
			                              <select style="height: 150px" name="anamnesis[cie10]" class="form-control">
			                                 ...
			                                 <?php foreach ($enfermedades as $enfermedad): ?>
			                                    <option <?php echo (isset($anamnesis->cie10) and ($enfermedad->id . ' - ' . $enfermedad->nombre == $anamnesis->cie10)) ? 'selected' : ''; ?> value="<?php echo $enfermedad->id . ' - ' . $enfermedad->nombre; ?>"><?php echo $enfermedad->id . ' - ' . $enfermedad->nombre; ?></option>
			                                 <?php endforeach; ?>
			                              </select>
			                           </div>
			                        </div>

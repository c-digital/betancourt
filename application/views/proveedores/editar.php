            ...
            <div class="panel-body panel-form">
                <div class="row">
                    <div class="col-md-9 col-sm-12">
                        ...
                        <?php echo form_open('pharmacy/proveedores/actualizar','class="form-inner"') ?>

                        	<input name="id"  type="hidden" class="form-control" value="<?= $proveedor->id;?>">

                            <div class="form-group row">
                                <label for="nombre" class="col-xs-3 col-form-label"><?php echo 'Nombre' ?> <i class="text-danger">*</i></label>
                                <div class="col-xs-9">
                                    <input name="nombre"  type="text" class="form-control" id="nombre" placeholder="<?php echo 'Nombre' ?>" value="<?= $proveedor->nombre;?>">
                                    <span></span>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="nit"  type="text" class="form-control" id="nit" placeholder="<?php echo 'NIT' ?>" value="<?= $proveedor->nit;?>">
                                    <span></span>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="telefono"  type="text" class="form-control" id="telefono" placeholder="<?php echo 'Telefono' ?>" value="<?= $proveedor->telefono;?>">
                                    <span></span>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="email"  type="text" class="form-control" id="email" placeholder="<?php echo display('email') ?>" value="<?= $proveedor->email;?>">
                                    <span></span>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="direccion"  type="text" class="form-control" id="direccion" placeholder="<?php echo 'Direccion' ?>" value="<?= $proveedor->direccion;?>">
                                    <span></span>
                                </div>
                            </div>

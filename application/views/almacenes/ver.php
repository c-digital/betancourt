                    ...
                    <tbody>
                        <?php if (!empty($productos)) { ?>
                            ...
                            <?php foreach ($productos as $producto) { ?>
                                <?php if ($producto->name == null) continue; ?>
                                ...
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                    ...
                                    <td><?php echo $producto->manufactured_by; ?></td>
                                    <td><?php echo (($producto->status==1)?display('active'):display('inactive')); ?></td>
                                    <?php
                                     if($this->permission->method('medicine_list','read')->access() || $this->permission->method('medicine_list','update')->access() || $this->permission->method('medicine_list','delete')->access()){
                                     ?>
                                    <td class="center" width="17%">
                                        <?php
                                         ...
                                         ?> 
                                          <a class="btn btn-primary btn-xs add_stock" data-id="<?= $producto->id;?>" data-toggle="modal" data-target="#modal_form">
                                         <?= display('add_stock')?>
                                          </a>
                                        <?php } ?>
                                        ...
                                        <?php
                                         if($this->permission->method('add_medicine','create')->access()){
                                         ?> 
                                          <a class="btn btn-primary btn-xs move" data-id="<?= $producto->id;?>" data-toggle="modal" data-target="#modal_move">
                                         Mover de almacen
                                          </a>
                                        <?php } ?>

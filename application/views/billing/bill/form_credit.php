                ...
                <div class="row">
                    <div class="col-sm-9">
                        <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-5">
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="patient_id" id="patient_id" value="<?php echo (isset($_GET['aid'])) ? $admission->patient_id : '' ?>" placeholder="<?php echo display('patient_id') ?>" readonly/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-6">
                                <div class="form-group">
                                    <input name="bill_date" type="text" class="form-control datepicker" id="bill_date" value="<?php echo (isset($_GET['aid'])) ? $admission->bill_date : '' ?>" placeholder="<?php echo display('bill_date') ?>" autocomplete="off"/>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-6">
                                <div class="form-group">

                ...
                <div class="row">
                    <div class="col-md-9 col-sm-12">
                        ...
                        <?php echo form_open('billing/service/form/'.$service->id,'class="form-inner"') ?>
                            ...
                            <div class="form-group row">
                                <label for="professional_commission" class="col-xs-3 col-form-label"><?php echo 'Comisión a profesional %' ?></label>
                                <div class="col-xs-9">
                                    <input name="professional_commission"  type="text" class="form-control" id="professional_commission" placeholder="<?php echo 'Comisión a profesional' ?>" value="<?php echo isset($service->professional_commission) ? $service->professional_commission : '' ?>">
                                </div>
                            </div>

            ...
            <div class="panel-body panel-form">
                <div class="row">
                    <div class="col-md-9 col-sm-12">
                        ...
                        <?php echo form_open('laboratorio/actualizar_examen','class="form-inner"') ?>

                            <?php echo form_hidden('id', $examen->id) ?>

                            <div class="form-group row">
                                <label for="name" class="col-xs-3 col-form-label"><?php echo 'Nombre'?> <i class="text-danger">*</i></label>
                                <div class="col-xs-9">
                                    <input name="nombre"  type="text" value="<?php echo $examen->nombre ?>" class="form-control" id="nombre" placeholder="<?php echo 'Nombre'?>">
                                </div>
                            </div>
                                ...
                                <div class="col-xs-9">
                                    <select name="categoria" class="form-control">
                                        ...
                                        <?php foreach ($categorias as $categoria): ?>
                                            <option <?php echo ($categoria->id == $examen->categoria) ? 'selected' : '' ?> value="<?php echo $categoria->id ?>"><?php echo $categoria->nombre ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="valor_referencia"  type="text" class="form-control" value="<?php echo $examen->valor_referencia ?>" id="valor_referencia" placeholder="<?php echo 'Valor de referencia'?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="precio"  type="text" class="form-control" id="nombre" value="<?php echo $examen->precio ?>" placeholder="<?php echo 'Precio'?>">
                                </div>
                            </div>
